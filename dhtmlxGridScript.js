data = {
    rows : [ {
        id : 1,
        data : [ 1, "Text1", "Text1", "Text1", "", "", "" ]
    }, {
        id : 2,
        data : [ 2, "Text2", "Text2", "Text2", "", "", "" ]
    }, {
        id : 3,
        data : [ 3, "Text3", "Text3", "Text3", "", "", "" ]
    }]
};
...
function onAddRow() {
    rowID = rowID + 1;
    myGrid.addRow(rowID, [ rowID, '', '', '', '', '', '' ],
            myGrid.getRowIndex(myGrid.getSelectedId()))
}
